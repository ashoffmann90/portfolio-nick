    ...
    return (
        <>
            <div className='player-wrapper-home'>
                <ReactPlayer key='nickreel' className='react-player-home' url={'https://youtu.be/DiTD--ceH_U'} controls={true} light={true} playing={true} width='100%' height='100%' volume='null' muted={false} />
            </div>
